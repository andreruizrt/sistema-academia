...
import company.service.ProfessorService;
...
public class AlunoRepository {
    ...
    public List<Aluno> carregaAlunos() {
        ...
        String sql = "SELECT IDALUNO, NOMEALUNO, CPFALUNO, IDPROFESSOR FROM ALUNO;";
...
//                System.out.println(rs.getInt("IDALUNO") + ") Nome: " + aluno.getNome() + "\n");
    ...
    public void insertAluno(Aluno aluno) {
        ...
        String sql = "INSERT INTO ALUNO(NOMEALUNO, CPFALUNO, IDPROFESSOR) VALUES (?, ?, ?)";
...
//                System.out.println(rs.getInt("IDALUNO") + ") Nome: " + aluno.getDsAluno() + "\n");
    ...
    public void updateAluno(Aluno aluno) throws SQLException {
        ...
        String sql = "UPDATE ALUNO SET NOMEALUNO = ?, CPFALUNO = ? WHERE IDALUNO = ?";
